...
export default function LivreurRow({ livreur: l, zones }: LivreurRowProps) {
  ...
  const [role, setRole] = useState(l.role)
      ...
      <div className="bg-slate-900 rounded-[2rem] border border-slate-800 p-6 shadow-xl animate-in fade-in zoom-in-95 duration-200">
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-[8px] font-black text-slate-500 uppercase tracking-widest mb-1 ml-1">Rôle</label>
              <select 
                value={role}
              ...
              >
                ...
                <option value="agent">Agent Dispatch</option>
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className={`px-2 py-0.5 rounded-full text-[8px] font-black uppercase tracking-widest ${
                l.role === 'admin' ? 'bg-purple-500/10 text-purple-600' :
                l.role === 'agent' ? 'bg-emerald-500/10 text-emerald-600' :
                l.role === 'livreur' ? 'bg-orange-500/10 text-orange-600' :
