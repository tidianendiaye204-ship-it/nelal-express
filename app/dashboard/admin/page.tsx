    ...
    <div className="max-w-7xl mx-auto space-y-10 pb-24 px-4 md:px-6">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex bg-slate-100 p-1 rounded-2xl">
          <Link href="/dashboard/admin/fleet" className="px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest text-orange-500 hover:text-orange-600 transition-colors bg-orange-50/50">📡 Flotte Live</Link>
